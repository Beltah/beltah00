...
if (badwordkick === 'TRUE' && isBotAdmin && !isAdmin && body && (new RegExp('\\b' + badword.join('\\b|\\b') + '\\b')).test(body.toLowerCase())) {
 ...
 client.sendMessage(m.chat, {text:`Adiós:\n\n@${kid.split("@")[0]},Beltah prohibited sending group links here!`, contextInfo:{mentionedJid:[kid]}}, {quoted:m}); 
       }   
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: 'https://wa.me/254114141192?text=ʜᴇʟʟᴏ+Beltah™𝕏+Nihostie+Bot+Mkuu+🥲',
                                mediaType: 1,
...
case "ping": case "speed": { 
	...
	await loadings ()
m.reply (`📡𝙱𝚎𝚕𝚝𝚊𝚑 𝙿𝚘𝚗𝚐 𝙻𝚊𝚝𝚎𝚗𝚌𝚢! *${dreadedspeed.toFixed(4)}* 𝐌𝐬`);
   } 
 break; 
  
 case "runtime": case "uptime": { 
                 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/a91218a98b91ec37fac81.mp4' }, caption: `┣❏𝐁𝐞𝐥𝐭𝐚𝐡-𝐓𝐞𝐜𝐡-𝐁𝐎𝐓 𝙷𝚊𝚜 𝙱𝚎𝚎𝚗 𝙰𝚌𝚝𝚒𝚟𝚎 𝙵𝚘𝚛\n┣❏ ${runtime(process.uptime())}`,gifPlayback: true }, { quoted: m }); 
 } 
 break;
...
case "movie": 
 ...
 break;
    ...
    break;
         ...
         for (let i of res) { 
             let txt = `*_</ ♻️𝐁𝐞𝐥𝐭𝐚𝐡-𝐓𝐞𝐜𝐡♻️𝐁𝐎𝐓 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}_*` 
