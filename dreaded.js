...
const botname = process.env.BOTNAME || '∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇';
const antibot = process.env.ANTIBOT || 'FALSE';
   ...
   const quoted = (fatkuns.mtype == 'buttonsMessage') ? fatkuns[Object.keys(fatkuns)[1]] : (fatkuns.mtype == 'templateMessage') ? fatkuns.hydratedTemplate[Object.keys(fatkuns.hydratedTemplate)[1]] : (fatkuns.mtype == 'product') ? fatkuns[Object.keys(fatkuns)[0]] : m.quoted ? m.quoted : m;
    ...
    const author = process.env.STICKER_AUTHOR ||'༺ E҈N҈G҈_ P҈A҈N҈T҈A҈N҈E҈༻';
    const packname = process.env.STICKER_PACKNAME || '𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒';
const dev = process.env.DEV || '254740312402';
const menu = process.env.MENU_TYPE || 'VIDEO';
 const DevDreaded = dev.split(",");
   ...
   const bad = process.env.BAD_WORD || 'fuck';
    ...
    const thum = fs.readFileSync ('./𝑝𝑎𝑛𝑡𝑎𝑛𝑒.jpg');	  
    const Owner = DevDreaded.map((v) => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(m.sender);
    const viewOnceMessage = args.join(" ");
    const fcontact = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': '༺ E҈N҈G҈_ P҈A҈N҈T҈A҈N҈E҈༻`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://wa.me/message/FNG2FKE4W4EWF1' }}}}
       // Group
...
const admin = process.env.ADMIN_MSG || '𝐇𝐮𝐡!\n𝐀𝐝𝐦𝐢𝐦𝐬 𝐨𝐧𝐥𝐲, 𝐝𝐢𝐦𝐰𝐢𝐭.';
    ...
    const NotOwner = process.env.NOT_OWNER_MSG || '𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒 𝐨𝐧𝐥𝐲 🗿';
...
"Contact owner after deploying",
	"┣❏𝙷𝚎𝚕𝚕𝚘 𝙷𝚎𝚛𝚎 𝚒𝚜 𝚢𝚘𝚞𝚛 𝚏𝚛𝚎𝚎 𝟸𝟶𝟶𝚖𝚋 𝚋𝚢 𝚍𝚘𝚠𝚗𝚕𝚘𝚊𝚍𝚒𝚗𝚐 𝚝𝚑𝚒𝚜 𝚊𝚙𝚙 𝚏𝚛𝚘𝚖 𝚙𝚕𝚊𝚢𝚜𝚝𝚘𝚛𝚎\n┣❏[https://play.google.com/store/apps/details?id=com.project.reson18&referrer=agent_code%3D4XASPS4]\n┣❏𝚃𝚑𝚎 𝚊𝚙𝚙 𝚒𝚜 𝚘𝚗𝚕𝚢 𝟾𝚖𝚋\n┣❏𝚁𝚎𝚐𝚒𝚜𝚝𝚎𝚛 𝚠𝚒𝚝𝚑 𝚢𝚘𝚞𝚛 𝚂𝚊𝚏𝚊𝚛𝚒𝚌𝚘𝚖 𝚕𝚒𝚗𝚎 𝚝𝚘 𝚐𝚎𝚝 𝚝𝚑𝚎 𝚍𝚊𝚝𝚊\n┣❏𝙵𝚎𝚎𝚍𝚋𝚊𝚌𝚔 𝚖𝚞𝚑𝚒𝚖𝚞 𝚗𝚍𝚒𝚘 𝚗𝚒𝚔𝚞𝚌𝚑𝚊𝚗𝚞𝚎 𝚗𝚊 𝚍𝚎𝚊𝚕 𝚣𝚒𝚗𝚐𝚒𝚗𝚎😂😂🤝\n┣❏𝙰𝚕𝚕 𝚝𝚑𝚊𝚗𝚔𝚜 𝚝𝚘 𝙱𝚎𝚕𝚝𝚊𝚑🙏😎."
]
...
"type .sc to access my source code",
	"𝐓𝐡𝐚𝐧𝐤 𝐘𝐨𝐮 𝐅𝐨𝐫 𝐖𝐚𝐢𝐭𝐢𝐧𝐠 😁\n\n┣❏𝚃𝚄𝚃𝙾𝚁𝙸𝙰𝙻 𝚅𝙸𝙳𝙴𝙾 𝙵𝙾𝚁 𝙳𝙴𝙿𝙻𝙾𝚈𝙸𝙽𝙶 𝚃𝙷𝙸𝚂 𝙱𝙾𝚃 𝙸𝚂 𝙽𝙾𝚃 𝚈𝙴𝚃 𝙰𝚅𝙰𝙸𝙻𝙰𝙱𝙻𝙴....\n\n┣❏🙂‍↕𝙰𝚜𝚔 𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚒𝚗 𝚍𝚎𝚙𝚕𝚘𝚢𝚖𝚎𝚗𝚝🙂‍↔ "
]
let { key } = await client.sendMessage(from, {text: '∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇'})
...
let { key } = await client.sendMessage(from, {text: '📡𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒 𝙿𝚘𝚗𝚐 𝙻𝚊𝚝𝚎𝚗𝚌𝚢'})
...
"༺♚𝐼𝑡𝑠〓𝑝𝑎𝑛𝑡𝑎𝑛𝑒✢༻🦋",
            "🗿",	
"🙂‍↕𝙻𝚘𝚊𝚍𝚎𝚍 𝚜𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 𝚋𝚢 ༺ E҈N҈G҈_ P҈A҈N҈T҈A҈N҈E҈༻🙂‍↔"
]
let { key } = await client.sendMessage(from, {text: '🙂‍↕𝙻𝚘𝚊𝚍𝚎𝚍 𝚜𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 𝚋𝚢 ༺ E҈N҈G҈_ P҈A҈N҈T҈A҈N҈E҈༻🙂‍↔'})
...
if (badwordkick === 'TRUE' && isBotAdmin && !isAdmin && body && (new RegExp('\\b' + badword.join('\\b|\\b') + '\\b')).test(body.toLowerCase())) {
     ...
     client.groupParticipantsUpdate(from, [sender], 'remove')
            reply("Adios Mf.\n\n𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒 hates usage of bad words!")
 ...
 client.sendMessage(m.chat, {text:`Adiós:\n\n@${kid.split("@")[0]},𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒 prohibited sending group links here!`, contextInfo:{mentionedJid:[kid]}}, {quoted:m}); 
       }   
...
if (antilink === 'TRUE' && antilinkall === 'TRUE' && body.includes('http') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`Auf wiedersehen:\n\n@${ki.split("@")[0]}, sending links is prohibited in this group!`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
    ...
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ 𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒 ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./𝑝𝑎𝑛𝑡𝑎𝑛𝑒.jpg'),
                                sourceUrl: 'https://wa.me/254740312402?text=ʜᴇʟʟᴏ+༺ E҈N҈G҈_ P҈A҈N҈T҈A҈N҈E҈༻+Ni_creatie+Bot+Mkuu+🥲',
                                mediaType: 1,
...
case "p": case "t": {
	await loadings ()
for (let i = 0; i < 5; i++) {
  m.reply(`𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒 𝙿𝚘𝚗𝚐 𝙻𝚊𝚝𝚎𝚗𝚌𝚢!\n *${dreadedspeed.toFixed(4)}* MS`);
  }
} 
break;
    ...
    if (fileSizeInMegabytes <= 40) {
      await client.sendMessage(
        from, {
          ...
          mimetype: "audio/mpeg",
          caption: "𓅃𝑤𝑎𝑚𝑢ℎ𝑢 𝑚𝑎𝑟𝑡𝑖𝑛𓅃|∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇
        }, {
          quoted: fcontact
        }
      );
...
case 'restart':  case 'reboot':
  if (!Owner) throw `𓅃𝑤𝑎𝑚𝑢ℎ𝑢 𝑚𝑎𝑟𝑡𝑖𝑛𓅃 Only` 
  reply(`∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇ is Restarting. . .`)  
  await sleep(3000)  
  process.exit()  
  break;
...
await m.reply('𝐑𝐞𝐦𝐨𝐯𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐛𝐲 𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒😬'); 
} catch (errr) { 
...
`▬▭▬▭▬▭▬▭▬▬▭▬▭▬▬▭▬\n┣❏Hello *${pushname}*▬▭▬▭▬▭▬▭▬▬▭▬▭▬▬▭▬\n\n┣❏𝚈𝚘𝚞 𝚌𝚊𝚗 𝚍𝚎𝚙𝚕𝚘𝚢 ∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇ 𝚞𝚜𝚒𝚗𝚐 𝚝𝚑𝚎 𝙶𝚒𝚝𝙷𝚞𝚋 𝚕𝚒𝚗𝚔 𝚋𝚎𝚕𝚘𝚠🗿\n\n┣❏𝙵𝚘𝚛𝚔 𝚊𝚗𝚍 𝚐𝚒𝚟𝚎 𝚞𝚜 𝚊 𝚜𝚝𝚊𝚛✨.\n┣❏contact 0740312402\n\n┣❏𝙴𝚗𝚓𝚘𝚢 𝚊𝚗𝚍 𝚑𝚊𝚟𝚎 𝚏𝚞𝚗 𝚠𝚒𝚝𝚑 𝚝𝚑𝚎 𝚋𝚘𝚝🗿...\n\n┣❏𝚄𝚜𝚎 𝚝𝚑𝚎 𝚕𝚒𝚗𝚔 𝚋𝚎𝚕𝚘𝚠 𝚝𝚘 𝚙𝚊𝚒𝚛 ∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇ 𝚠𝚒𝚝𝚑𝚘𝚞𝚝 𝚜𝚌𝚊𝚗𝚗𝚒𝚗𝚐 𝚊𝚗𝚢 𝚚𝚛 𝚌𝚘𝚍𝚎\n┣❏[ask pantane to send it to you]\n\n┣❏𝚃𝚄𝚃𝙾𝚁𝙸𝙰𝙻 𝚅𝙸𝙳𝙴𝙾 𝙵𝙾𝚁 𝙳𝙴𝙿𝙻𝙾𝚈𝙸𝙽𝙶 𝚃𝙷𝙸𝚂 𝙱𝙾𝚃 𝙸𝚂 𝙽𝙾𝚃 𝚈𝙴𝚃 𝙰𝚅𝙰𝙸𝙻𝙰𝙱𝙻𝙴.\n┣❏🙂‍↕𝙰𝚜𝚔 𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚒𝚗 𝚍𝚎𝚙𝚕𝚘𝚢𝚖𝚎𝚗𝚝🙂‍↔\n┣❏༺♚𝐼𝑡𝑠〓𝑝𝑎𝑛𝑡𝑎𝑛𝑒✢༻🦋[wa.me/254740312402]\n┣❏𝙵𝚘𝚕𝚕𝚘𝚠 𝚖𝚢 𝚌𝚑𝚊𝚗𝚗𝚎𝚕 𝚏𝚘𝚛 𝚞𝚙𝚍𝚊𝚝𝚎𝚜 𝚊𝚗𝚍 𝚌𝚘𝚘𝚕 𝚜𝚝𝚊𝚏𝚏 𝚘𝚗 [𝙰𝙸]\n┣❏[https://whatsapp.com/channel/0029VaYVZND7tkjHsCqAM93r]\n\n\n𝙼𝚊𝚍𝚎 𝚘𝚗 𝚎𝚊𝚛𝚝𝚑 𝚋𝚢 Pantane𝚔𝚎\n▬▭▬▭▬▭▬▭▬▬▭▬▭▬▬▭▬` });
 ...
 m.reply('Group successfully locked by 𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒!'); 
 } 
 break; 
 ...
 m.reply('Group successfully unlocked by 𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒!'); 
 ...
 m.reply('  𝐂𝐫𝐨𝐰𝐧𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 by 𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒! 👑'); 
         } 
 break; 
 case "demote": { 
                 if (!m.isGroup) throw group; 
 ...
 m.reply('  𝐝𝐞𝐦𝐨𝐭𝐞𝐝 𝐡𝐞𝐚𝐫𝐭𝐥𝐞𝐬𝐬𝐥𝐲 by 𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒! 😬'); 
         } 
 break;
	      case "d7": case "disp7": { 
                 if (!m.isGroup) throw group; 
 ...
 m.reply('Group name successfully updated by 𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒! 👍'); 
             } 
             break; 
 ...
 m.reply('Group description successfully updated by 𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒! 👍'); 
             } 
 break; 
 case "hidetag": { 
             if (!m.isGroup) throw group; 
  ...
  case 'play':
    case 'play2': {
        ...
        try {
			...
			caption: "𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 by 𝙱𝚛𝚒𝚊𝚗 𝚠𝚊𝚒𝚗𝚊𝚒𝚗𝚊",    
                    }, {
                        quoted: fcontact 
                    }
                );
...
case "ping": case "speed": { 
	...
	await loadings ()
m.reply (`𝑒𝑛𝑔 𝑝𝑎𝑛𝑡𝑎𝑛𝑒 𝙿𝚘𝚗𝚐 𝙻𝚊𝚝𝚎𝚗𝚌𝚢! *${dreadedspeed.toFixed(4)}* 𝐌𝐬`);
   } 
 break; 
  
 case "runtime": case "uptime": { 
                 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/a91218a98b91ec37fac81.mp4' }, caption: `┣❏∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇ 𝙷𝚊𝚜 𝙱𝚎𝚎𝚗 𝙰𝚌𝚝𝚒𝚟𝚎 𝙵𝚘𝚛\n┣❏ ${runtime(process.uptime())}`,gifPlayback: true }, { quoted: m }); 
 } 
 break;

case "alive": { 
  
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/5e29ca126d7a46aa3aef4.mp4' }, caption: `┣❏𝐇𝐞𝐥𝐥𝐨 *${m.pushName}*\n\n┣❏∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇ 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐚𝐥𝐢𝐯𝐞 𝐬𝐢𝐧𝐜𝐞\n┣❏*${runtime(process.uptime())} \n\n∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇`,gifPlayback: true }, { quoted: m });
 }
break;
case 'apk': {
...
client.sendMessage(from, buttonMessage, { quoted: m }) 
 ...
 break 
    ...
    exec(`ffmpeg -i ${media} ${pantane}`, (err) => { 
   fs.unlinkSync(media); 
   if (err) throw err 
   let buffer = fs.readFileSync(pantane); 
   client.sendMessage(m.chat, { image: buffer, caption: `*𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐝 𝐛𝐲 ∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇*`}, { quoted: m }) 
   fs.unlinkSync(pantane); 
    }); 
    } 
...
case "movie": 
 ...
 break;
    ...
    break;
         ...
         for (let i of res) { 
             let txt = `*_</ ∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇ 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}_*` 
 ...
 break;
        ...
        case "gpt": case "g": 
            ...
            if (!text) return reply("Hello am ∆☬𝔭𝔞𝔫𝔱𝔞𝔫𝔢 ✐𝔅𝔬𝔱𓅃☬∇ an Ai developed by 𓅃𝑤𝑎𝑚𝑢ℎ𝑢 𝑚𝑎𝑟𝑡𝑖𝑛𓅃⸼, how can I help you today?");
